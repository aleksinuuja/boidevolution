...
function initiateTweenValues()
	...
	tweenEngine:newKeyAndValue("logTextY", 0) -- value used to zoom in and out the whole game
	tweenEngine:newKeyAndValue("logAlpha", 0) -- value used to zoom in and out the whole game
end
